package com.AluraChallenger.ForoHub.service;

import com.AluraChallenger.ForoHub.Topic;
import com.AluraChallenger.ForoHub.TopicRepository;
import com.AluraChallenger.ForoHub.repository.TopicRepository;
...
public class TopicService {
    ...
    public <Topic> List<Topic> findAll() {
        return topicRepository.findAll();
    }

    public <Topic> Optional<Topic> findById(Long id) {
        return topicRepository.findById(id);
    }

    public <Topic> Topic save(Topic topic) {
